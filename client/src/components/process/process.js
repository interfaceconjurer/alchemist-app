      ...
      <section className="process-wrap">
        ...
        <ul className="process-wrap-ul">
          ...
          <ProcessStep>
            ...
            <p>This is where you start to map out the ecosystem of where your problem lives. What are the scenarios in which the problems your addressing come to life? From this analysis you will start to define your moments of engagement. From these key moments, start to dig into what are the specific flows and processes that happen around these moments and scenarios. From this you will start to get a clearer picture of how far your solution will need to reach to be effective.  </p>
          </ProcessStep>
          <ProcessStep>
            <figure>
          ...
          <ProcessStep>
            ...
            <p>Now that you have a comprehensive lay of the land, start sketching, writing, contemplating, whatever you do to get your creative mojo right. Your focus should be set by all your pre-work, now its time to get creative. Find inspiration, look at competitors, how have similar problems already been solved. No need to recreate the wheel, there's a time to be original, and other times a perfectly good pattern is already established. Understanding the mapping of different solutions to customer/user value will help guide you. </p>
          </ProcessStep>
          <ProcessStep>
            <figure>
